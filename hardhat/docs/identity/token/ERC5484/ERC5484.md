...
> You can extends this contract to implement Consensual SBTs.

An implementation of Consensual Soulbound Token.

*Implements EIP-5484: Consensual Soulbound Tokens - https://eips.ethereum.org/EIPS/eip-5484*
